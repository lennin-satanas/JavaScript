...
// console.log("movil", piezas);
var piezas2 = document.getElementsByClassName('fondo');
...
function reordenar(evt) {
  ...
  //manado a la funcion para animar el fondo
  animationTab(clone, id);
...
function animationTab(clone, id) {
  ...
  switch (id)  {
    ...
    case '0' : piezas2[0].classList.add('prueba');
      ...
      return;
    case '1': piezas2[1].classList.add('prueba');
              setTimeout(()=>removeClass(id),3000);
      return;
    case '2': piezas2[2].classList.add('prueba');
              setTimeout(()=>removeClass(id),3000);
      return;  
    case '3' : piezas2[3].classList.add('prueba');
               setTimeout(()=>removeClass(id),3000);
      return;
    case '4': piezas2[4].classList.add('prueba');
              setTimeout(()=>removeClass(id),3000);
      return;
    case '5' : piezas2[5].classList.add('prueba');
              setTimeout(()=>removeClass(id),3000);
      return;
    case '6': piezas2[6].classList.add('prueba');
              setTimeout(()=>removeClass(id),3000);
      return;
    case '7' : piezas2[7].classList.add('prueba');
               setTimeout(()=>removeClass(id),3000);
      return;
    case '8': piezas2[8].classList.add('prueba');
              setTimeout(()=>removeClass(id),3000);
      return;
...
function removeClass(id){
  switch (id) {
    case '0' : piezas2[0].classList.remove('prueba');
      return;
    case '1': piezas2[1].classList.remove('prueba');
      return;
    case '2': piezas2[2].classList.remove('prueba');
      return;  
    case '3' : piezas2[3].classList.remove('prueba');
      return;
    case '4': piezas2[4].classList.remove('prueba');
      return;
    case '5' : piezas2[5].classList.remove('prueba');
      return;
    case '6': piezas2[6].classList.remove('prueba');
      return;
    case '7' : piezas2[7].classList.remove('prueba');
      return;
